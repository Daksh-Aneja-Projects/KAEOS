...
async def seed_tenant(db, tenant: str) -> bool:
    # A second run must not duplicate rows or crash on the encounter_number
    # unique constraint.
    if await already_seeded(db, "Healthcare", PatientEncounter, tenant):
        return False
    ...
    # is seeded CLOSED.
    encounters = [
        PatientEncounter(id=new_id(), tenant_id=tenant, encounter_number="ENC-2026-0001",
        ...
        PatientEncounter(id=new_id(), tenant_id=tenant, encounter_number="ENC-2026-0002",
        ...
        PatientEncounter(id=new_id(), tenant_id=tenant, encounter_number="ENC-2026-0003",
        ...
        PatientEncounter(id=new_id(), tenant_id=tenant, encounter_number="ENC-2026-0004",
        ...
        PatientEncounter(id=new_id(), tenant_id=tenant, encounter_number="ENC-2026-0005",
        ...
        PatientEncounter(id=new_id(), tenant_id=tenant, encounter_number="ENC-2026-0006",
        ...
        PatientEncounter(id=new_id(), tenant_id=tenant, encounter_number="ENC-2026-0007",
        ...
        PatientEncounter(id=new_id(), tenant_id=tenant, encounter_number="ENC-2026-0008",
    ...
    disclosures = [
        PHIDisclosure(id=new_id(), tenant_id=tenant, encounter_id=by_ref["pt-anon-4821"].id,
        ...
        PHIDisclosure(id=new_id(), tenant_id=tenant, encounter_id=by_ref["pt-anon-8842"].id,
        ...
        PHIDisclosure(id=new_id(), tenant_id=tenant, encounter_id=by_ref["pt-anon-1190"].id,
        ...
        PHIDisclosure(id=new_id(), tenant_id=tenant, encounter_id=by_ref["pt-anon-3357"].id,
        ...
        PHIDisclosure(id=new_id(), tenant_id=tenant, encounter_id=by_ref["pt-anon-5501"].id,
    ...
    consents = [
        ConsentRecord(id=new_id(), tenant_id=tenant, patient_ref="pt-anon-4821",
                      scope="treatment_payment_operations", part2=False, granted_at=_ago(days=400)),
        ConsentRecord(id=new_id(), tenant_id=tenant, patient_ref="pt-anon-5501",
                      scope="part2_substance_use_disclosure", part2=True, granted_at=_ago(days=6)),
        ConsentRecord(id=new_id(), tenant_id=tenant, patient_ref="pt-anon-3357",
                      scope="research_participation", part2=False, granted_at=_ago(days=30)),
        ConsentRecord(id=new_id(), tenant_id=tenant, patient_ref="pt-anon-7735",
        ...
        ConsentRecord(id=new_id(), tenant_id=tenant, patient_ref="pt-anon-9014",
    ...
    report = ComplianceReport(
        id=new_id(), tenant_id=tenant, framework="HIPAA",
