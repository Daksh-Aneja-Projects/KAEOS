"""KAEOS Alembic env.py — wired to app models and async engine."""
...
# KAEOS imports — load all models so autogenerate detects them
...
def run_migrations_online() -> None:
    ...
    # For SQLite (sync), use standard approach
