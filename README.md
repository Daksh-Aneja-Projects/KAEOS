...
| Object Explorer: a generic UI over the Enterprise Ontology | Open core shell, Enterprise data | Available: browse typed objects, apply governed ActionTypes through the same gate pipeline, see markings and masked properties - the surface ships in the open core and shows the capability notice where the Enterprise package is absent |
