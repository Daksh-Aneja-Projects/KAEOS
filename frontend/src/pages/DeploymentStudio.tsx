                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-0.5">
                            <span className="text-[11px] font-mono px-2 py-0.5 rounded-full" style={{ background: colors.primary + '15', color: colors.primary }}>v{pack.version}</span>
                    ...
                    {(selectedPack?.required_integrations || []).map((req: any, i: number) => {
                      ...
                      return (
                        <div key={i} className="flex items-center gap-3 p-3 rounded-lg border" style={{ borderColor: colors.hairline }}>
                          ...
                          {connected ? (
                            <span className="flex items-center gap-1 text-[11px] font-bold" style={{ color: '#22c55e' }}><CheckCircle className="w-3 h-3" /> {connected.name}</span>
                          ) : (
                            <button onClick={() => navigate('/integrations')} className="px-2 py-1 rounded text-[11px] font-medium" style={{ background: '#f59e0b15', color: '#f59e0b' }}>Connect</button>
                          )}
                        </div>
                      );
                    })}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div style={card}>
                ...
                <div className="mt-3 flex items-center gap-1 text-[11px]" style={{ color: colors.inkSubtle }}>
